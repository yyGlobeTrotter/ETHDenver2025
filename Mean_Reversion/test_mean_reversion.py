...
def test_bollinger_bands_artifact():
    ...
    try:
        ...
        message, artifact = get_token_bollinger_bands.invoke({"token_id": token, "window": 20, "num_std": 2.0})
...
def test_backtest_strategy():
    ...
    try:
        ...
        if artifact and 'results' in artifact:
            ...
            results = strategy.backtest_strategy(token, days=days, initial_capital=initial_capital)
